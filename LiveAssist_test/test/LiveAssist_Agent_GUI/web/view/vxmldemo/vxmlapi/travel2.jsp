...
<vxml version="2.0">
    ...
    <form id="mainMenuForm">
        ...
        <var name="pickList" expr="'book-flight|getstatus-flight'"/>
        ...
        <field name="callSteeringField">
            ...
            <grammar src="${contentPath}/travel/mainmenu.grxml"/>
            ...
            <filled>
                ...
                <if cond="laState == 'agentFilled'">
                    <assign name="mainMenuIntent" expr="laGetLiveAssistResult.outcome"/>
                    <prompt>
                        Ok I got it with agent's help.
                    </prompt>
                    <goto next="#travelForm"/>
                ...
                <else/>
                    <assign name="mainMenuIntent" expr="lastresult$.interpretation.intent"/>
                    <prompt>
                        Ok got it.
                    </prompt>
                    <goto next="#travelForm"/>
            ...
            <nomatch>
                ...
                <else/> <!-- notEscalated -->
                    ...
                    <prompt>
                        Maybe a little differently, like i would like to book a flight 
                        or i would like to know the status of a flight
    ...
    <form id="travelForm">
        ...
        <field name="travelField">
            ...
            <prompt cond="laState == 'start'">
                So you want <value expr="mainMenuIntent"/>
                And for what flight? For example you can say from Boston to Austin on Tuesday.
            </prompt>
            <filled>
                <var name="recognitionResult" expr="'' + lastresult$.emmatext"/>
                <var name="utterance" expr="'' + lastresult$.recording"/>
