...
US3662: Implement Escalation Engine Interface
 TC1552: Getting details about a particular escalationClassifier instance that is not exists

 **/
//QA test case description, verification & assertion check
describe("TC1552: Getting details about a particular escalationClassifier instance that is not exists\n", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1552 : Verify Getting details about a particular escalationClassifier instance that is not exists", function (done) {
        ...
        async.series([
			...
			function(callback){
                var testBodyParam = "";
                test_client.get(testBaseURL + '/NeverEscalatingEscalationClassifierNotExists' , function(err, res, body){
                    if(err){
            ...
            function(err, result){
                ...
                try{
					...
					expect(result[1][1]).to.match(/There is no 'interface com.nuance.liveassist.escalation.IEscalationClassifier' instance named 'NeverEscalatingEscalationClassifierNotExists'/);
