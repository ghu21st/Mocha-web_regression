...
US3662: Implement Escalation Engine Interface
 TC1557: Getting details about a particular escalationClassifier instance that is PrePackaged

 **/
//QA test case description, verification & assertion check
describe("TC1557: Getting details about NeverEscalatingEscalationClassifier\n", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1557 : Verify Getting details about NeverEscalatingEscalationClassifier", function (done) {
