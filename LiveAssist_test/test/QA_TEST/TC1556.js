...
US3770: Support Escalation Engine Properties
 TC1556:  Verify US3770 Support escalation engine properties of an unknown property name
...
describe("TC1556:   Verify updating configuration of managed instances of an unknown property name", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1556:  updating configuration of managed instances of an unknown property name ", function (done) {
        ...
        async.series([
            ...
            function(callback){
                ...
                var testBodyParam = "";
                test_client.post(testBaseURL + '/PercentageBasedEscalationClassifier/setProperty/unknownproperty/100' , testBodyParam, function(err, res, body){
                    if(err){
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[1][1]).to.match(/Property 'unknownproperty' not found/);
