        ...
        async.series([
            ...
            function(callback){
                ...
                var testBodyParam = JSON.stringify({
                    ...
                    //"grammars":testBaseGrammarURI,  //####### Set none for this case testing ##################
					//"grammarIds":testGrammarIds	//####### Set none for this case testing ##################
                });
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[4][1].interactionID).to.match(/session:Nuance-Test2:/);
