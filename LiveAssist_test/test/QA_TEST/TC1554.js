...
US3662: Implement Escalation Engine Interface
 TC1554: Verify activating an escalation classifier instance to be PercentageBasedEscalationClassifier
 **/
//QA test case description, verification & assertion check
describe("TC1554: Verify activating an escalation classifier instance to be PercentageBasedEscalationClassifier \n", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1501: Verify activating one of the instances  to be AlwaysEscalatingEscalationClassifier\n", function (done) {
        ...
        async.series([
            ...
            function(err, result){
                ...
                try{
                    ...
                    //TODO: To update the validation of the response when any change happen
