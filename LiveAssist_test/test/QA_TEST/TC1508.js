/**
 TC15108:  - Verify Uploading a new escalation classifier instance from application/json should return error
 **/
//QA test case description, verification & assertion check0
describe("TC1508:   Verify Uploading a new escalation classifier instance when the bytes contained in the body do not represent a valid instance of the specified type", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1508:  Verify Uploading a new escalation classifier instance from application/json", function (done) {
        ...
        async.series([
            ...
            function(callback){
                ...
                var testBodyParam = "\{\"PUT TimeBasedEscalationClassifier.groovy\"\:\{\"method\"\:\"PUT\"\,\"url\"\:\"http\:\/\/10.3.41.61\:8080\/liveassist\/rest\/escalationClassifiers\/TimeBasedEscalationClassifier\"\,\"body\"\:\package com.nuance.samples\n\nimport com.nuance.liveassist.escalation.*\n\nclass TimeBasedEscalationClassifier implements IEscalationClassifier {\n  EscalationResult classify(IClassificationParameters params) {\n        int hour = Calendar.getInstance().get(Calendar.HOUR_OF_DAY)\n        if (hour < 9)\n            return EscalationResult.DO_NOT_ESCALATE\n        if (hour > 17)\n            return EscalationResult.DO_NOT_ESCALATE\n        return EscalationResult.ESCALATE\n  }\n}\n\,\"overrideMimeType\"\:false\,\"headers\"\:\[\[\"Content-Type\"\,\"application\/x-groovy\"\]\]\}\}";
            ...
            function(err, result){
                ...
                try{
					...
					expect(result[2][0].statusCode).to.eql(400);
