...
US3662: Implement Escalation Engine Interface
 TC1536:  Verify Removing an escalation classifier instance - Verify Removing the instance TimeBasedEscalationClassifier"
 **/
//QA test case description, verification & assertion check0
describe("TC1536:  Verify Removing an escalation classifier instance - Verify Removing the instance TimeBasedEscalationClassifier", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1536: Verify Removing unknown instance", function (done) {
        ...
        async.series([
            ...
            function(callback){
                ...
                test_client.delete(testBaseURL  + '/unknownInstance', function(err, res, body){
                    if(err){
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[1][1]).to.match(/No \'interface com.nuance.liveassist.escalation.IEscalationClassifier\' instance with name \'unknownInstance\' exists/);
