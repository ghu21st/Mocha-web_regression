...
US3662: Implement Escalation Engine Interface
 TC1558: Getting details about a particular escalationClassifier instance that is PrePackaged

 **/
//QA test case description, verification & assertion check
describe("TC1558: Getting details ConfidenceBasedEscalationClassifier\n", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1558 : Verify Getting details about ConfidenceBasedEscalationClassifier", function (done) {
        ...
        async.series([
            ...
            function(callback){
                var testBodyParam = "";
                test_client.get(testBaseURL + '/ConfidenceBasedEscalationClassifier' , function(err, res, body){
                    if(err){
