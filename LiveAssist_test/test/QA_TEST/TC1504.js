...
US3662: Implement Escalation Engine Interface
 TC1504:  Verify Removing an escalation classifier instance - Verify Removing a pre-built (prepackaged) escalation classifier instance"
 **/
//QA test case description, verification & assertion check0
describe("TC1504:  Verify Removing an escalation classifier instance - Verify Removing a pre-built (prepackaged) escalation classifier instance", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1504: Verify Removing a pre-built  prepackaged  escalation classifier instance", function (done) {
        ...
        async.series([
            ...
            function(callback){
                ...
                test_client.delete(testBaseURL + '/NeverEscalatingEscalationClassifier' , function(err, res, body){
                    if(err){
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[1][1]).to.match(/Only externally added \'interface com.nuance.liveassist.escalation.IEscalationClassifier\' file instances can be removed/);
