...
US3662: Implement Escalation Engine Interface
 TC1501: Verify activating an escalation classifier instance to be AlwaysEscalatingEscalationClassifier
 **/
//QA test case description, verification & assertion check
describe("TC1501: Verify activating an escalation classifier instance to be AlwaysEscalatingEscalationClassifier \n", function () {
    //QA test setup ----------------------------------------------
        ...
        async.series([
            ...
            function(err, result){
                ...
                try{
					...
					expect(result[1][1]).to.match(/\"implementationClassName\":\"com.nuance.liveassist.server.escalation.AlwaysEscalatingEscalationClassifier\"/);
					expect(result[1][1]).to.match(/\"source\":\"PrePackaged\"/);
					expect(result[1][1]).to.match(/\"active\":true/);
					// expect(result[1][1]).to.match(/\"unwrappedInstance\":{\"confidenceThreshold\":\"0.5\"}/);
