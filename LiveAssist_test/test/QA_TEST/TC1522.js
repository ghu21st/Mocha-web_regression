...
�	US3269: Implement confidence based routing
 TC1522: Verify listing ConfidenceBasedEscalationClassifier when listing all escalation classifier instance

 **/
//QA test case description, verification & assertion check
describe("TC1522: Verify listing ConfidenceBasedEscalationClassifier when listing all escalation classifier instance\n", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1522: Verify listing ConfidenceBasedEscalationClassifier when listing all escalation classifier instances", function (done) {
        ...
        async.series([
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[1][1]).to.match(/\"ConfidenceBasedEscalationClassifier\"/);
