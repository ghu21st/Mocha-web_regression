...
US3662: Implement Escalation Engine Interface
 TC1503: Getting details about a particular escalationClassifier instance that is PrePackaged

 **/
//QA test case description, verification & assertion check
describe("TC1503: Getting details about AlwaysEscalatingEscalationClassifier\n", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1503 : Verify Getting details about AlwaysEscalatingEscalationClassifier", function (done) {
