...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1006: Verify that session storage debug API get sessions and basic session storage info", function (done) {
        ...
        //        var testBaseURL2 = 'http://' + TEST_HOST + ':' + TEST_PORT + '/liveassist/rest/vxmlapp'; //deprecated api
            ...
            function(callback){
                ...
                function(callback){
                    ...
                    var testBodyParam = JSON.stringify({
                        ...
                        "userInputText":"This is session #1 test"
                    });
                ...
                function(callback){
                    ...
                    var testBodyParam = JSON.stringify({
                        ...
                        "configurationName":"mainmenu",
                        "completionCause":"no-match",
                        "userInputText":"This is session #2 test"
                    });
...
//                    expect(result[3][1].state).to.match(/agentPending/);
//                    expect(result[3][1].completionCause).to.match(/null/);

                    expect(result[4][0].statusCode).to.eql(200);
//                    expect(result[4][1].state).to.match(/agentPending/);
//                    expect(result[4][1].completionCause).to.match(/null/);

                    //verify result session
                   expect(ret_result).to.match(/\"id\"/)
//                        .and.to.have.string(sessions[0])
                        .and.to.match(/\"varName\":\"Nuance-WebApiCallSteering\"/)
                        .and.to.match(/\"varVersion\":\".+\"/)
                        .and.to.match(/\"ani\":null/)
                        .and.to.match(/\"dnis\":null/)
                        .and.to.match(/\"externalSessionID\":\"0a0325e7_000011c2_5307b580_00d4_0001\"/)
 //                       .and.to.match(/\"escalated\":true/)
                        .and.to.match(/\"userInputText\":\"This is session #1 test\"/);
 ...
 //                       .and.to.have.string(sessions[1])
                        ...
                        .and.to.match(/\"externalSessionID\":\"0a0325e7_000011c2_5307b580_00d4_0001\"/)
  //                      .and.to.match(/\"escalated\":true/)
                        .and.to.match(/\"userInputText\":\"This is session #2 test\"/);

//"id":"session:Nuance-WebApiCallSteering:2a3f303c-b7e6-4aec-8ab7-fdd4d29efdf1","varName":"Nuance-WebApiCallSteering","varVersion":"1.0",
// "ani":null,"dnis":null,"aai":null,"externalSessionID":"0a0325e7_000011c2_5307b580_00d4_0001","audioRelayServerUrl":null,
// "applicationConfiguration":{"id":"5","name":"Nuance-WebApiCallSteering","organizationIDApplicationIDList":[],"dnisList":[],"contextList":
// [{"id":"4","name":"mainmenu","assistGrammarList":[],"escalationClassifierId":"AlwaysEscalatingEscalationClassifier","pickListId":"nuance/webapicallsteering/intents.json",
// "commandGrammarList":[],"parameterList":[]}]},"recognitionContext":{"activeGrammar":null,"applicationContextConfiguration":{"id":"4","name":"mainmenu",
// "assistGrammarList":[],"escalationClassifierId":"AlwaysEscalatingEscalationClassifier","pickListId":"nuance/webapicallsteering/intents.json","commandGrammarList":[],
// "parameterList":[]},"escalationClassifierId":"AlwaysEscalatingEscalationClassifier","pickListId":"nuance/webapicallsteering/intents.json","name":"mainmenu"},
// "canStreamAudio":false,"currentInteractionId":"session:Nuance-WebApiCallSteering:2a3f303c-b7e6-4aec-8ab7-fdd4d29efdf1-0","interactions":
// [{"sessionId":"session:Nuance-WebApiCallSteering:2a3f303c-b7e6-4aec-8ab7-fdd4d29efdf1","id":"session:Nuance-WebApiCallSteering:2a3f303c-b7e6-4aec-8ab7-fdd4d29efdf1-0","pickListId":"nuance/webapicallsteering/intents.json","userInputText":"I want to take a plane to go see my grandmother in New York on the 25th around 4","utteranceUrl":null,"recognitionResultProvided":true,"completionCause":null,"agentUsername":null,"outcome":null,"topInterpretation":null}],"shouldEscalate":false,"escalated":true,"sessionStats":{"stepTimes":{"CREATE":{"date":1401390111992},"START_SESSION":{"date":1401390111992},"START_INTERACTION":{"date":1401390112000},"SEND_INTERACTION_RESULT":{"date":1401390112000},"ESCALATE":{"date":1401390112000}}},"viewName":null,"variableNames":null,"outcome":null,"currentInteraction":{"sessionId":"session:Nuance-WebApiCallSteering:2a3f303c-b7e6-4aec-8ab7-fdd4d29efdf1",
