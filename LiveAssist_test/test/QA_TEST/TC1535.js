...
US3662: Implement Escalation Engine Interface
 ...
 TC1535:  Verify Removing an escalation classifier instance - Verify Removing unknown instance"
 **/
//QA test case description, verification & assertion check0
describe("TC1535:  Verify Removing an escalation classifier instance - Verify Removing unknown instance", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1535: Verify Removing unknown instance TimeBasedEscalationClassifier", function (done) {
        ...
        async.series([
            ...
            function(err, result){
                ...
                try{
                   ...
                   // expect(result[1][1]).to.match(/No \'interface com.nuance.liveassist.escalation.IEscalationClassifier\' instance with name \'TimeBasedEscalationClassifier\' exists/);
