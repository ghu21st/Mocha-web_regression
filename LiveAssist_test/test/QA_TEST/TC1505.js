/**
 ...
 TC1505:  Verify Uploading a new escalation classifier instance (groovy type) then Removing it
 **/
//QA test case description, verification & assertion check
describe("TC1505:   Verify Uploading a new escalation classifier instance from groovy type then Removing it", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1505:  Verify Uploading a new escalation classifier instance from groovy type then remove it", function (done) {
        ...
        async.series([
            ...
            function(err, result){
                ...
                try{
                    ...
                    //TODO: To update the validation of the response after the fixing the defect DE1142
