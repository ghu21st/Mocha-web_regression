...
US3770: Support Escalation Engine Properties
 TC1553:  Verify US3770 Support escalation engine properties of an unknown instance name
...
describe("TC1553:   Verify updating configuration of managed instances", function () {
    //QA test setup ----------------------------------------------
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1553:  updating configuration of managed instances of an unknown instance name ", function (done) {
        ...
        async.series([
            ...
            function(callback){
                ...
                var testBodyParam = "";
                test_client.post(testBaseURL + '/UnknownEscalationClassifier/setProperty/percentage/100' , testBodyParam, function(err, res, body){
                    if(err){
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[1][1]).to.match(/There is no 'interface com.nuance.liveassist.escalation.IEscalationClassifier' instance named 'UnknownEscalationClassifier'/);
