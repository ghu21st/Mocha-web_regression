/*
 web_2012: Web GUI test simulator - agent response outcome result with - Ottawa to New York on Wednesday
 */
...
async.series([
    ...
    //2. Agent Web Test Driver - Travel app outcome --------------------------------------------------
    function(callback){
        //start web test driver based on app driver session
        //set base agent web page URL
    ...
    function(callback){
        ...
        select.sendKeys("Ottawa").then(function(){
...
//               option.click().then(function(){
    ...
    function(callback){
        ...
        select.sendKeys("New York").then(function(){
...
//                option.click().then(function(){
    ...
    function(callback){
        ...
        select.sendKeys("Wednesday").then(function(){
...
//                option.click().then(function(){
    ...
    function(err, result){
        ...
        try{
            ...
            if(result[12][1].search(sessionID) == -1){
