/*
 web_2004: Web GUI test simulator - agent response outcome result with - Other, with customized QA outcome result
 */
...
async.series([
    ...
    function(callback){
        ...
        var element1 = driver.findElement(webdriver.By.xpath("//input[@id='pickListSelection5']"));
        if(element1.isDisplayed()){
    ...
    function(callback){
        // Customize (case by case) input text box for other outcome selections
        var element1 = driver.findElement(webdriver.By.xpath("//input[@id='otherText']"));
        if(element1.isDisplayed()){
            element1.clear().then(function(){
                element1.sendKeys('QA customized outcome result selection').then(function(){
                    output_msg = '\nQA customized outcome result selection';//for debugging
                    output_string += output_msg;
                    console.log(output_msg);
                    //
                    callback(null, 103);
    ...
    function(callback){
        ...
        var element1 = driver.findElement(webdriver.By.xpath("//input[@id='pickListSelection5']"));
        var element2 = driver.findElement(webdriver.By.xpath("//input[@id='otherText']"));
