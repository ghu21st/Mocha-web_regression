/*
 web_2001: Web GUI test simulator - agent response outcome result with - change my tariff
 */
...
async.series([
    ...
    function(callback){
        ...
        var element1 = driver.findElement(webdriver.By.xpath("//input[@id='pickListSelection2']"));
        if(element1.isDisplayed()){
    ...
    function(callback){
        ...
        var element1 = driver.findElement(webdriver.By.xpath("//input[@id='pickListSelection2']"));
        var element2 = driver.findElement(webdriver.By.xpath("//input[@id='pickListSelection3']"));
