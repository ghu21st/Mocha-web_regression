/*
 web_2200: Web GUI test simulator - agent response outcome result with - request-agent for verification that cancelInteraction and endSession usage from call steering demo app
 */
...
async.series([
    ...
    function(callback){
        ...
        var element1 = driver.findElement(webdriver.By.xpath("//input[@id='pickListSelection1']"));
        var element2 = driver.findElement(webdriver.By.xpath("//input[@id='pickListSelection2']"));
