/*
 web_2007: Web GUI test simulator - agent response outcome result with - technical support
 */
...
async.series([
    ...
    function(callback){
        ...
        var element1 = driver.findElement(webdriver.By.xpath("//input[@id='pickListSelection3']"));
        if(element1.isDisplayed()){
    ...
    function(callback){
        ...
        var element1 = driver.findElement(webdriver.By.xpath("//input[@id='pickListSelection3']"));
        var element2 = driver.findElement(webdriver.By.xpath("//input[@id='pickListSelection4']"));
