/*
 web_2202: Web GUI test simulator - agent response outcome result with - request-agent for verification that cancelInteraction and endSession usage from call steering demo app by end to end QA-user call -> agent web GUI -> Hangup -> check session log
 TC2202: Agent Web UI login
 **/
