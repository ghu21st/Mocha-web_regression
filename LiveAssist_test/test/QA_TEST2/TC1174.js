//TC1174: Verify that Live Assist agent data input section with custom outcome selection (Billing) -> (Balance) -> (Explain balance)
//-------------------------------------------------------

describe('TC1174: Verify that Live Assist agent data input section with custom outcome selection (Billing) -> (Balance) -> (Explain balance)', function() {
...
//-------------------------------------------------------
    it('TC1174: Verify that Live Assist agent data input section with custom outcome selection (Billing) -> (Balance) -> (Explain balance)', function(done) {
        ...
        async.series([
                ...
                //Check the data input section from agent gui
                function(callback){
                    //test on ng-repeat  ##############
                    element1 = ptor.element.all(protractor.By.repeater('selectedIntent in selectedIntents')).then(function(arr){
                        arr[0].evaluate('selectedIntent.name').then(function(selected_intent_name){
                            output_msg = '\nData input section intent:\n' + selected_intent_name;
                            output_string += output_msg;
                            logger.info(output_msg);
                                //
                            var result = [selected_intent_name, 0];
                            callback(null, result);
                        });
                    });
                },
