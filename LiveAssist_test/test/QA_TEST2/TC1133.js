//TC1133: Verify that Live Assist agent GUI sign out right after sign in
//-------------------------------------------------------
describe('TC1133: Verify that Live Assist agent GUI sign out right after sign in', function() {
//QA test setup ----------------------------------------------
    var case_ID = 1133;
...
//-------------------------------------------------------
    it('TC1133: Verify that Live Assist agent GUI sign out right after sign in', function(done) {
        //trace HTTP call
        //nock.recorder.rec();
