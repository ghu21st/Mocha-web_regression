//TC1138: Verify that Live Assist simple IVR API method /inputInteractionStep -> agent intent selection -> done -> check session return with /inputInteractionStep
//-------------------------------------------------------
describe('TC1138: Verify that Live Assist simple IVR API method /inputInteractionStep -> agent intent selection -> check session return with /inputInteractionStep', function() {
...
//-------------------------------------------------------
    it('TC1138: Verify that Live Assist simple IVR API method /inputInteractionStep -> agent intent selection -> done -> check session return with /inputInteractionStep', function(done) {
