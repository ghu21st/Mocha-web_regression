//TC1155: Verify that Live Assist sample app agent with update contact info intent and custom values: (account) -> (update contact info) -> (new_address = QA_addr) -> (new_phone = 5147703199) -> (new email = QA@nuance.com)
//-------------------------------------------------------
describe('TC1155: Verify that Live Assist sample app agent with update contact info intent and custom values: (account) -> (update contact info) -> (new_address = QA_addr) -> (new_phone = 5147703199) -> (new email = QA@nuance.com)', function() {
...
//-------------------------------------------------------
    it('TC1155: Verify that Live Assist sample app agent with update contact info intent and custom values: (account) -> (update contact info) -> (new_address = QA_addr) -> (new_phone = 5147703199) -> (new email = QA@nuance.com)', function(done) {
                            ...
                            arr[2].evaluate('variable.name').then(function (var_name) {
                                ...
                                element2.click().then(function(){
                                    ...
                                    element3.clear().then(function(){
                                        element3.sendKeys('QA_addr').then(function () {

                                            //arr[3] - NEW_PHONE_NUMBER
                                            arr[3].evaluate('variable.id').then(function(var_id) {
                                                arr[3].evaluate('variable.name').then(function (var_name) {
                                                    ...
                                                    element2.click().then(function(){
                                                        element3 = ptor.element.all(protractor.By.id(var_id)).get(0);
                                                        element3.clear().then(function() {
                                                            element3.sendKeys('5147703199').then(function () {
                                                                //

                                                                //arr[4] - NEW_EMAIL
                                                                arr[4].evaluate('variable.id').then(function(var_id) {
                                                                    arr[4].evaluate('variable.name').then(function (var_name) {
                                                                        var_id_res.push(var_id);
                                                                        var_name_res.push(var_name);
                                                                        ...
                                                                        element2.click().then(function () {
                                                                            element3 = ptor.element.all(protractor.By.id(var_id)).get(0);
                                                                            element3.clear().then(function () {
                                                                                element3.sendKeys('QA@nuance.com').then(function () {
                                                                                    //
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[17][1]).to.match(/\"completionCause\":\"success\"/)
                        ...
                        .and.to.match(/\"value\":\"UPDATE_CONTACT_INFORMATION\"/)
                        .and.to.match(/\"variables\":/)
                        .and.to.match(/\"id\":\"NEW_ADDRESS\"/)
                        .and.to.match(/\"value\":\"QA_addr\"/)
                        .and.to.match(/\"id\":\"NEW_PHONE_NUMBER\"/)
                        .and.to.match(/\"value\":\"5147703199\"/)
                        .and.to.match(/\"id\":\"NEW_EMAIL\"/)
                        .and.to.match(/\"value\":\"QA@nuance.com\"/)
