//TC1167: Verify that Live Assist GUI go back to idle state and ready for next call after alert popup and dismiss button confirmed when maximum time elapse from agent
//-------------------------------------------------------
describe('TC1167: Verify that Live Assist GUI go back to idle state and ready for next call after alert popup and dismiss button confirmed when maximum time elapse from agent', function() {
//QA test setup ----------------------------------------------
    var case_ID = 1167;
...
//-------------------------------------------------------
    it('TC1167: Verify that Live Assist GUI go back to idle state and ready for next call after alert popup and dismiss button confirmed when maximum time elapse from agent', function(done) {
        ...
        async.series([
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[21][1]).to.match(/\"completionCause\":\"success\"/)
