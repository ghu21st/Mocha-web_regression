//TC1144: Verify that Live Assist sample app agent gui with billing intent outcome: (Billing) -> (Balance) -> (Check balance)
//-------------------------------------------------------

describe('TC1144: Verify that Live Assist sample app agent gui with billing intent outcome: (Billing) -> (Balance) -> (Check balance) ', function() {
...
//-------------------------------------------------------
    it('TC1144: Verify that Live Assist sample app agent gui with billing intent outcome: (Billing) -> (Balance) -> (Check balance) ', function(done) {
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[16][1]).to.match(/\"completionCause\":\"success\"/)
                        ...
                        .and.to.match(/\"value\":\"CHECK_BALANCE\"/)
