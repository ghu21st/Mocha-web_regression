//TC1148: Verify that Live Assist sample app agent select flight intent with default city outcome value selection from the list: (Flight) -> (Booking) -> (Boston) -> (Austin)
//-------------------------------------------------------

describe('TC1148: Verify that Live Assist sample app agent select flight intent with default city outcome value selection from the list: (Flight) -> (Booking) -> (Boston) -> (Austin)', function() {
...
//-------------------------------------------------------
    it('TC1148: Verify that Live Assist sample app agent select flight intent with default city outcome value selection from the list: (Flight) -> (Booking) -> (Boston) -> (Austin)', function(done) {
                            ...
                            arr[0].evaluate('variable.name').then(function (var_name) {
                                ...
                                //input box handling
                                    ...
                                    element2.click().then(function(){
                                       ...
                                       //     element3.sendKeys('Boston').then(function () {

                                            //arr[1] - arrival city
                                            arr[1].evaluate('variable.id').then(function(var_id) {
                                                arr[1].evaluate('variable.name').then(function (var_name) {
                                                    var_id_res.push(var_id);
                                                    var_name_res.push(var_name);
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[17][1]).to.match(/\"completionCause\":\"success\"/)
                        ...
                        .and.to.match(/\"value\":\"Boston\"/)
                        .and.to.match(/\"id\":\"ARRIVAL_CITY\"/)
                        .and.to.match(/\"value\":\"Austin\"/)
