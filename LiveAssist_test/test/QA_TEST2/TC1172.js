//TC1172: Verify that Live Assist simple IVR API call should not be escalated using Nuance-IvrApiCallSteering app and configName=othermenu with ConfidenceBasedEscalationClassifier and set confidence=0.9 > default 0.5
//us3269, DE3055
//-------------------------------------------------------
describe('TC1172: Verify that Live Assist simple IVR API call should not be escalated using Nuance-IvrApiCallSteering app and configName=othermenu with ConfidenceBasedEscalationClassifier and set confidence=0.9 > default 0.5', function() {
...
//-------------------------------------------------------
    it('TC1172: Verify that Live Assist simple IVR API call should not be escalated using Nuance-IvrApiCallSteering app and configName=othermenu with ConfidenceBasedEscalationClassifier and set confidence=0.9 > default 0.5', function(done) {
        ...
        async.series([
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[9][1]).to.match(/<state>useASRResult<\/state>/);

                    expect(result[13][1]).to.match(/<inputInteractionStepResult>/)
                        .and.to.match(/<state>useASRResult<\/state>/)
                        .and.to.match(/<\/inputInteractionStepResult>/);
//?xml version="1.0" encoding="UTF-8" standalone="yes"?><inputInteractionStepResult><sessionID>session:Nuance-IvrApiCallSteering:3167b938-1f6b-4800-bf51-6ddf5bda5abe</sessionID><state>useASRResult</state></inputInteractionStepResult>
