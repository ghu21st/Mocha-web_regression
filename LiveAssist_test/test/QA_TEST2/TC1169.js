//TC1169: Verify that user sign in as administrator role with valid username and password to admin gui

//-------------------------------------------------------
describe('TC1169: Verify that user sign in as administrator role with valid username and password to admin gui', function() {
//QA test setup ----------------------------------------------
    var case_ID = 1169;
...
//-------------------------------------------------------
    it('TC1169: Verify that user sign in as administrator role with valid username and password to admin gui', function(done) {
        //trace HTTP call
        //nock.recorder.rec();
        ...
        async.series([
                ...
                function(callback){
                    ...
                    element1.sendKeys('laadmin').then(function(){
                ...
                function(callback){
                    ...
                    element1.sendKeys('changeit').then(function(){
                ...
                function(callback){
                    ...
                    element1 = ptor.element(protractor.By.partialButtonText('Sign in as Administrator'));
                ...
                function(callback){
                    //test on ng-click and button #####################
                    element1 = ptor.element(protractor.By.binding('mode'));
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[8][0]).to.match(/Admin Mode/); //login page (all point to /app)
