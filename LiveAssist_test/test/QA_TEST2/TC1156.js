//TC1156: Verify that Live Assist global contextual variables from agent GUI selection added to IVR api call response (outcome return)
//-------------------------------------------------------
describe('TC1156: Verify that Live Assist global contextual variables from agent GUI selection added to IVR api call response (outcome return)', function() {
...
//-------------------------------------------------------
    it('TC1156: Verify that Live Assist global contextual variables from agent GUI selection added to IVR api call response (outcome return)', function(done) {
        ...
        async.series([
                ...
                function(callback){
                    ...
                    ptor.element.all(protractor.By.repeater('intent in intents')).then(function(arr){
                        arr[3].evaluate('intent.name').then(function(intent_name){  //#3 is set for 'operator', but if id# changed, update at here
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[18][1]).to.match(/\"completionCause\":\"success\"/)
                        ...
                        .and.to.match(/\"value\":\"OPERATOR\"/)
                        .and.to.match(/\"variables\":null/)
                        .and.to.match(/\"globals\":/)
                        .and.to.match(/"ENGLISH\",\"MALE\"/)
