//TC1185: Verify that Live Assist popup calendar when agent selecting default date via waive fee intent (yyyy-mm) with keyboard action
//US7411 As a Live Assist application developer I want to show a calendar popup to agents when selecting a date
//-------------------------------------------------------
describe('TC1185: Verify that Live Assist popup calendar when agent selecting default date via waive fee intent (yyyy-mm) with keyboard action', function() {
...
//-------------------------------------------------------
    it('TC1185: Verify that Live Assist popup calendar when agent selecting default date via waive fee intent (yyyy-mm) with keyboard action', function(done) {
                        ...
                        arr[0].evaluate('variable.id').then(function(var_id) {
                            arr[0].evaluate('variable.name').then(function (var_name) {
                                ...
                                element2.sendKeys(protractor.Key.SPACE).then(function(){       //trigger the date
                                    ...
                                    element3.sendKeys(protractor.Key.ENTER).then(function(){          //trigger calendar popup calendar
                                        ptor.driver.getAllWindowHandles().then(function(handles) {
                                            ...
                                            ptor.driver.switchTo().window(handles[0]).then(function(){
                                                //var datepickerDate = ptor.element.all(protractor.By.model('date')).first();
                                                //datepickerDate.sendKeys(protractor.Key.ENTER).then(function(){
                                    ...
                                    //***************************************  mouse click for popup calendar control buttons: 'Today', 'Clear', 'Close'
/*                                                //var datepickerDate = ptor.element(protractor.By.css('.datepicker')).element(protractor.By.buttonText('Close'));
                                                var datepickerMonth = ptor.element(protractor.By.buttonText('Today'));
                                                datepickerMonth.click().then(function(){
//                                                    var datepickerClose = ptor.element(protractor.By.buttonText('Close'));
//                                                    datepickerClose.click().then(function () {
                                                        //var datepickerDate = ptor.element.all(protractor.By.model('date')).first();
                                                        //datepickerDate.clear().then(function(){
                                                        //datepickerDate.sendKeys('2014-12').then(function(){
                                                        //
                ...
                function(callback){
                    ...
                    ptor.driver.wait(function(){
                        ...
                        if(b){
                            ...
                            //pressed sign out button - robust
                            element1 = ptor.element(protractor.By.id('signOutButton'));
                            element1.sendKeys(protractor.Key.ENTER).then(function(){
                                output_msg = '\nsignOutButton button pressed';
                                output_string += output_msg;
