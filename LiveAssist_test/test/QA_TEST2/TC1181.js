//TC1181: Verify that Live Assist dynamic escalation classifier with confidence input > maximum_confidence_threshold and high_confidence_percentage=100
//US6815 dynamic escalation classifier
//-------------------------------------------------------
describe('TC1181: Verify that Live Assist dynamic escalation classifier with confidence input > maximum_confidence_threshold and high_confidence_percentage=100', function() {
...
//-------------------------------------------------------
    it('TC1181: Verify that Live Assist dynamic escalation classifier with confidence input > maximum_confidence_threshold and high_confidence_percentage=100', function(done) {
        ...
        var test_item1 = [
            ...
            {applicationContextId: 3, name: 'high_confidence_percentage', value: '100'},
        ...
        async.series([
                ...
                function(callback){
                    ...
                    //recognition emma result sent, conf = 0.6
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[6][1]).to.match(/\"applicationContextId\":3,\"name\":\"minimum_confidence_threshold\",\"value\":\"0\"/)
                        .and.to.match(/\"applicationContextId\":3,\"name\":\"maximum_confidence_threshold\",\"value\":\"0.5\"/)
                        ...
                        .and.to.match(/\"applicationContextId\":3,\"name\":\"high_confidence_percentage\",\"value\":\"100\"/);
