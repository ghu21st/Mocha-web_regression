//TC1196: Verify that Live Assist MRCP API with resultMediaType for EMMA-> agent outcome selection -> agent GUI response & summary
//-------------------------------------------------------
describe('TC1196: Verify that Live Assist MRCP API with resultMediaType for EMMA-> agent outcome selection -> agent GUI response & summary', function() {
...
//-------------------------------------------------------
    it('TC1196: Verify that Live Assist MRCP API with resultMediaType for EMMA-> agent outcome selection -> agent GUI response & summary', function(done) {
        ...
        async.series([
                ...
                function(callback){
                    ...
                    var testBodyParam = JSON.stringify({
                        ...
                        resultMediaType:"application/x-vnd.nuance.emma+xml",
