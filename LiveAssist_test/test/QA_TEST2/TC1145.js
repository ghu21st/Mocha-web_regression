//TC1145: Verify that Live Assist sample app agent gui with custom outcome selection (Billing) -> (Balance) -> (Explain balance) 
//-------------------------------------------------------

describe('TC1145: Verify that Live Assist sample app agent gui with custom outcome selection (Billing) -> (Balance) -> (Explain balance) ', function() {
...
//-------------------------------------------------------
    it('TC1145: Verify that Live Assist sample app agent gui with custom outcome selection (Billing) -> (Balance) -> (Explain balance) ', function(done) {
