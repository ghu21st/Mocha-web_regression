//TC1170: Verify that Live Assist with default settings show session details on agent screen via MRCP api call escalated
//-------- US3276 Add session details to the agent screen
//-------------------------------------------------------
describe('TC1170: Verify that Live Assist with default settings show session details on agent screen via MRCP api call escalated', function() {
...
//-------------------------------------------------------
    it('TC1170: Verify that Live Assist with default settings show session details on agent screen via MRCP api call escalated', function(done) {
...
// sessionStats=SessionStats[{CREATE=1401133560554, START_SESSION=1401133560554}],viewName=null
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[16][0]).to.match(/from: 4641/)
                        .and.to.match(/to: 4628/)
                        .and.to.match(/Nuance-MrcpApiCallSteering/)
                        .and.to.match(/mainmenu/);


                    expect(result[22][1]).to.match(/\"applicationID\":\"MrcpApiCallSteering\"/)
