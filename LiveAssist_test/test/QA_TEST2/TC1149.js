//TC1149: Verify that Live Assist sample app agent gui with operator intent outcome
//-------------------------------------------------------
describe('TC1149: Verify that Live Assist sample app agent gui with operator intent outcome', function() {
...
//-------------------------------------------------------
    it('TC1149: Verify that Live Assist sample app agent gui with operator intent outcome', function(done) {
        ...
        async.series([
                ...
                function(callback){
                    ...
                    element1 = ptor.findElements(protractor.By.repeater('intent in intents').column('name')).then(function(arr){
                        arr[3].getText().then(function(intent_name){  //#3 is set for 'operator', but if id# changed, update at here
