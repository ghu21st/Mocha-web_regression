//TC1199: Verify that Live Assist MRCP API with resultMediaType set to NLSML type but recognitionResult using EMMA format input - call should not escalated to agent
//-------------------------------------------------------
describe('TC1199: Verify that Live Assist MRCP API with resultMediaType set to NLSML type but recognitionResult using EMMA format input - call should not escalated to agent', function() {
...
//-------------------------------------------------------
    it('TC1199: Verify that Live Assist MRCP API with resultMediaType set to NLSML type but recognitionResult using EMMA format input - call should not escalated to agent', function(done) {
...
// sessionStats=SessionStats[{CREATE=1401133560554, START_SESSION=1401133560554}],viewName=null
                ...
                function(callback){
                    ...
                    test_client.post(testAPIURL + '/sendRecognitionResult  ', testBodyParam, function(err, res, body){
                        ...
                        output_msg += '\npost test body param: ' + testBodyParam; //for debugging
                        output_msg += '\nResponse: ' + JSON.stringify(res); //res.statusCode;//for debugging
                        output_msg += '\nBody: ' + body_ret;//for debugging
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[13][0].statusCode).to.eql(400);
                    expect(result[13][1]).to.match(/This is not an nlsml result/);
