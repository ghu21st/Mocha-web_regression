//TC1183: Verify that Live Assist customize major parameters from applicationContextParams table in the DB and returned properly via IVR api call test and agent outcome response
//US6817 applicationContexParams
//-------------------------------------------------------
describe('TC1183: Verify that Live Assist customize major parameters from applicationContextParams table in the DB via IVR api call test and agent outcome response', function() {
...
//-------------------------------------------------------
    it('TC1183: Verify that Live Assist customize all major parameters from applicationContextParams table in the DB and returned properly via IVR api call test and agent outcome response', function(done) {
        ...
        var test_item1 = [
            {applicationContextId: 3, name: 'minimum_confidence_threshold', value: '0.15'},
            {applicationContextId: 3, name: 'maximum_confidence_threshold', value: '0.95'},
            ...
            {applicationContextId: 3, name: 'high_confidence_percentage', value: '99'},
            {applicationContextId: 3, name: 'agent_pending_completion_cause', value: 'no-match'},
            {applicationContextId: 3, name: 'agent_pending_recognition_result', value: 'QA_AGENT_PENDING'}
        ];
        ...
        async.series([
            ...
            function (callback) {
                //Assign input table for updates
                var test_item_table = test_item1;
            ...
            //MySQL driver single update and commit transaction
            function (callback) {
                mysql_connection.beginTransaction(function(err) {
                    if (err) {
                        logger.info('MySQL test driver error: ' + err.stack);
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[6][1]).to.match(/\"applicationContextId\":3,\"name\":\"minimum_confidence_threshold\",\"value\":\"0.15\"/)
                        .and.to.match(/\"applicationContextId\":3,\"name\":\"maximum_confidence_threshold\",\"value\":\"0.95\"/)
                        .and.to.match(/\"applicationContextId\":3,\"name\":\"immediate_percentage\",\"value\":\"100\"/)
                        .and.to.match(/\"applicationContextId\":3,\"name\":\"agent_pending_completion_cause\",\"value\":\"no-match\"/)
                        .and.to.match(/\"applicationContextId\":3,\"name\":\"agent_pending_recognition_result\",\"value\":\"QA_AGENT_PENDING\"/);
