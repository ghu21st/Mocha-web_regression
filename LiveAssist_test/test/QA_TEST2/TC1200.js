//TC1200: Verify that Live Assist MRCP API with resultMediaType set to EMMA type but recognitionResult using NLSML format input - call should not be escalated to agent
//-------------------------------------------------------
describe('TC1200: Verify that Live Assist MRCP API with resultMediaType set to EMMA type but recognitionResult using NLSML format input - call should not be escalated to agent', function() {
...
//-------------------------------------------------------
    it('TC1200: Verify that Live Assist MRCP API with resultMediaType set to EMMA type but recognitionResult using NLSML format input - call should not be escalated to agent', function(done) {
...
// sessionStats=SessionStats[{CREATE=1401133560554, START_SESSION=1401133560554}],viewName=null
                ...
                function(callback){
                    ...
                    var testBodyParam = JSON.stringify({
                        ...
                        resultMediaType:"application/x-vnd.nuance.emma+xml", //EMMA type
                        //NLSML format input -
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[13][1]).to.match(/This is not an emma result/);
