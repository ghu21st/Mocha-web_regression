//TC1173: Verify that Live Assist simple IVR API call should be escalated using Nuance-IvrApiCallSteering app and configName=othermenu with ConfidenceBasedEscalationClassifier and set confidence=0.3 < default 0.5
//us3269, DE3055
//-------------------------------------------------------
describe('TC1173: Verify that Live Assist simple IVR API call should be escalated using Nuance-IvrApiCallSteering app and configName=othermenu with ConfidenceBasedEscalationClassifier and set confidence=0.3 < default 0.5', function() {
...
//-------------------------------------------------------
    it('TC1173: Verify that Live Assist simple IVR API call should be escalated using Nuance-IvrApiCallSteering app and configName=othermenu with ConfidenceBasedEscalationClassifier and set confidence=0.3 < default 0.5', function(done) {
        ...
        async.series([
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[16][1]).to.match(/<inputInteractionStepResult>/)
