//TC1161: Verify that Live Assist gui keyboard input billing intent with custom variable values as agent outcome
//-------------------------------------------------------
describe('TC1161: Verify that Live Assist billing intent with custom variable values as agent outcome selected from GUI by keyboard input', function() {
...
//-------------------------------------------------------
    it('TC1161: Verify that Live Assist billing intent with custom variable values as agent outcome selected from GUI by keyboard input', function(done) {
        ...
        async.series([
                    ...
                    ptor.element.all(protractor.By.repeater('variable in selectedIntents[selectedIntents.length - 1].variables')).then(function(arr){
                        ...
                        arr[0].evaluate('variable.id').then(function(var_id) {
                            arr[0].evaluate('variable.name').then(function (var_name) {
                                ...
                                //element2.sendKeys(protractor.Key.ENTER).then(function(){
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[20][1]).to.match(/\"completionCause\":\"success\"/)
