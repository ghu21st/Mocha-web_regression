//TC1195: Verify that Live Assist MRCP API with resultMediaType for EMMA -> agent intent selection -> check session return
//-------------------------------------------------------
describe('TC1195: Verify that Live Assist MRCP API with resultMediaType for EMMA -> agent intent selection -> check session return', function() {
...
//-------------------------------------------------------
    it('TC1195: Verify that Live Assist MRCP API with resultMediaType for EMMA -> agent intent selection -> check session return', function(done) {
