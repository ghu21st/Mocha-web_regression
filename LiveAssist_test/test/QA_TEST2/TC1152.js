//TC1152: Verify that Live Assist sample app agent select waive fee intent with customized billing date outcome value: (Billing) -> (Late fee) -> (waive fee) -> (2014-12-21)
//-------------------------------------------------------
describe('TC1152: Verify that Live Assist sample app agent select waive fee intent with customized billing date outcome value: (Billing) -> (Late fee) -> (waive fee) -> (2014-12-21)', function() {
...
//-------------------------------------------------------
    it('TC1152: Verify that Live Assist sample app agent select waive fee intent with customized billing date outcome value: (Billing) -> (Late fee) -> (waive fee) -> (2014-12-21)', function(done) {
