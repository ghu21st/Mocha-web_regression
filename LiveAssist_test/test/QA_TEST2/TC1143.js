//TC1143: Verify that Live Assist call triggered from MRCP API -> agent outcome selection -> agent GUI response & selection summary
//-------------------------------------------------------
describe('TC1143: Verify that Live Assist call triggered from MRCP API -> agent outcome selection -> agent GUI response & selection summary', function() {
...
//-------------------------------------------------------
    it('TC1143: Verify that Live Assist call triggered from MRCP API -> agent outcome selection -> agent GUI response & selection summary', function(done) {
