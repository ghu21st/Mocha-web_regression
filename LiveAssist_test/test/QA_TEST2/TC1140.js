//TC1140: Verify that Live Assist simple web API method /inputInteractionStep -> agent intent selection -> done -> check session return with /inputInteractionStep
//-------------------------------------------------------
describe('TC1140: Verify that Live Assist simple web API method /inputInteractionStep -> agent intent selection -> check session return with /inputInteractionStep', function() {
...
//-------------------------------------------------------
    it('TC1140: Verify that Live Assist simple web API method /inputInteractionStep -> agent intent selection -> done -> check session return with /inputInteractionStep', function(done) {
