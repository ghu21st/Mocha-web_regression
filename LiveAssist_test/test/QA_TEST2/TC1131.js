//TC1131: Verify that Live Assist agent GUI welcome page -> sign in page
//-------------------------------------------------------
describe('TC1131: Verify that Live Assist agent GUI welcome page -> sign in page', function() {
//QA test setup ----------------------------------------------
    var case_ID = 1131;
...
//-------------------------------------------------------
    it('TC1131: Verify that Live Assist agent GUI welcome page -> sign in page', function(done) {
        //trace HTTP call
        //nock.recorder.rec();
  ...
  */          function(callback){
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[1][0]).to.match(/https:.+\/liveassist\/app/);
                    expect(result[2][0]).to.match(/Nuance Live Assist/);
                    //expect(result[3][0]).to.match(/What\'s next/);
                    expect(result[3][0]).to.match(/https:.+liveassist\/app/);
