//TC1160: Verify that Live Assist GUI keyboard input CTRL+num on billing intent with default variables as agent outcome selected
//-------------------------------------------------------
describe('TC1160: Verify that Live Assist GUI keyboard input CTRL+num and CTRL+Enter on billing intent with default variables as agent outcome selected', function() {
...
//-------------------------------------------------------
    it('TC1160: Verify that Live Assist GUI keyboard input CTRL+num and CTRL+Enter on billing intent with default variables as agent outcome selected', function(done) {
