//TC1203: Verify that Live Assist no agent timeout via MRCP API and return useASRResult after default timeout
//US7697
//-------------------------------------------------------
describe('TC1203: Verify that Live Assist no agent timeout via MRCP API and return useASRResult after default timeout', function() {
...
//-------------------------------------------------------
    it('TC1203: Verify that Live Assist no agent timeout via MRCP API and return useASRResult after default timeout', function(done) {
        ...
        async.series([
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[10][1].completionCause).to.match(/success/);
                    expect(result[10][1].state).to.match(/useLiveAssistResult/);

                    expect(result[12][0].statusCode).to.eql(200);
                    expect(result[12][1].completionCause).to.match(/success/);
                    expect(result[12][1].state).to.match(/useLiveAssistResult/);

                    expect(result[14][0].statusCode).to.eql(200);
                    expect(result[14][1].completionCause).to.match(/null/);
                    expect(result[14][1].state).to.match(/useASRResult/);
