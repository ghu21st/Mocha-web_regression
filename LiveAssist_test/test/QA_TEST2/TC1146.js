//TC1146: Verify that Live Assist sample app agent gui with billing intent outcome: (Billing) -> (Late fee) -> (Explain fee)
//-------------------------------------------------------

describe('TC1146: Verify that Live Assist sample app agent gui with billing intent outcome: (Billing) -> (Late fee) -> (explain fee) ', function() {
...
//-------------------------------------------------------
    it('TC1146: Verify that Live Assist sample app agent gui with billing intent outcome: (Billing) -> (Late fee) -> (explain fee) ', function(done) {
