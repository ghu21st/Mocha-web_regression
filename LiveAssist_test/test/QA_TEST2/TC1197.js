//TC1197: Verify that Live Assist MRCP API with resultMediaType for NLSML -> agent intent selection -> check session return
//-------------------------------------------------------
describe('TC1197: Verify that Live Assist MRCP API with resultMediaType for NLSML -> agent intent selection -> check session return', function() {
...
//-------------------------------------------------------
    it('TC1197: Verify that Live Assist MRCP API with resultMediaType for NLSML -> agent intent selection -> check session return', function(done) {
...
// sessionStats=SessionStats[{CREATE=1401133560554, START_SESSION=1401133560554}],viewName=null
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[21][1]).to.match(/\"applicationID\":\"MrcpApiCallSteering\"/)
