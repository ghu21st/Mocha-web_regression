//TC1189: Verify that Live Assist popup calendar when agent selecting date with basic keyboard control Home - Page Up - Page Down
//US7411 As a Live Assist application developer I want to show a calendar popup to agents when selecting a date
// -------------------------------------------------------
describe('TC1189: Verify that Live Assist popup calendar when agent selecting date with basic keyboard control Home - Page Up - Page Down', function() {
...
//-------------------------------------------------------
    it('TC1189: Verify that Live Assist popup calendar when agent selecting date with basic keyboard control Home - Page Up - Page Down', function(done) {
            ...
            function(err, result){
                ...
                try{
                    ...
                    Date.prototype.yyyy_next = function() {
                        var yyyyNext = this.getFullYear() + 1;
