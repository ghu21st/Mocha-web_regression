//TC1153: Verify that Live Assist sample app agent select waive fee intent with customized late fee payment reason outcome value: (Billing) -> (Late fee) -> (waive fee) -> (2014-12-21) -> (QA_Customized_Reason)
//-------------------------------------------------------
describe('TC1153: Verify that Live Assist sample app agent select waive fee intent with customized late fee payment reason outcome value: (Billing) -> (Late fee) -> (waive fee) -> (2014-12-21) -> (QA_Customized_Reason)', function() {
...
//-------------------------------------------------------
    it('TC1153: Verify that Live Assist sample app agent select waive fee intent with customized late fee payment reason outcome value: (Billing) -> (Late fee) -> (waive fee) -> (2014-12-21) -> (QA_Customized_Reason)', function(done) {
                            ...
                            arr[0].evaluate('variable.name').then(function (var_name) {
                                ...
                                element2.click().then(function(){
                                    ...
                                    element3.clear().then(function(){
                                        element3.sendKeys('2014-12').then(function () {
                                            //arr[1] - arrival city
                                            arr[1].evaluate('variable.id').then(function(var_id) {
                                                arr[1].evaluate('variable.name').then(function (var_name) {
                                                    ...
                                                    element2.click().then(function(){
                                                        element3 = ptor.element.all(protractor.By.id(var_id)).get(0);
                                                        element3.clear().then(function() {
                                                            element3.sendKeys('QA_Customized_Reason').then(function () {
                                                                //
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[17][1]).to.match(/\"completionCause\":\"success\"/)
                        ...
                        .and.to.match(/\"value\":\"2014-12\"/)
                        .and.to.match(/\"id\":\"LATE_PAYMENT_REASON\"/)
                        .and.to.match(/\"value\":\"QA_Customized_Reason\"/)
