//TC1142: Verify that Live Assist call triggered from MRCP API -> agent intent selection -> check session return
//-------------------------------------------------------
describe('TC1142: Verify that Live Assist call triggered from MRCP API -> agent intent selection -> check session return', function() {
...
//-------------------------------------------------------
    it('TC1142: Verify that Live Assist call triggered from MRCP API -> agent intent selection -> check session return', function(done) {
