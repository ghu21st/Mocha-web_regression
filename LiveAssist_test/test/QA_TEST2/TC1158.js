//TC1158: Verify that Live Assist agent keyboard input select global contextual variables as agent outcome via SPACE key and ENTER key for done button
//-------------------------------------------------------
describe('TC1158: Verify that Live Assist agent keyboard input select global contextual variables as agent outcome via SPACE key and ENTER key for done button', function() {
...
//-------------------------------------------------------
    it('TC1158: Verify that Live Assist agent keyboard input select global contextual variables as agent outcome via SPACE key and ENTER key for done button', function(done) {
        ...
        async.series([
                ...
                function(callback){
                    ...
                    element3 = ptor.element(protractor.By.id(chk1));
                        //keyboard
                    element3.sendKeys(protractor.Key.SPACE).then(function(){
                ...
                function(callback){
                    //test checkbox on ng-repeat  ##############
                    var chk1 = 'UNINTENDED_INPUT' + 'CheckBox';
                    element3 = ptor.element(protractor.By.id(chk1));
                    //keyboard
                    element3.sendKeys(protractor.Key.SPACE).then(function(){
                        output_msg = '\ncheckbox selection: ' + chk1;
                ...
                function(callback){
                    //test checkbox on ng-repeat  ##############
                    var chk1 = 'NO_MATCHING_INTENT' + 'CheckBox';
                    element3 = ptor.element(protractor.By.id(chk1));
                    //keyboard
                    element3.sendKeys(protractor.Key.SPACE).then(function(){
                        output_msg = '\ncheckbox selection: ' + chk1;
                ...
                function(callback){
                    //test checkbox on ng-repeat  ##############
                    var chk1 = 'NO_INPUT_FROM_USER' + 'CheckBox';
                    element3 = ptor.element(protractor.By.id(chk1));
                    //keyboard
                    element3.sendKeys(protractor.Key.SPACE).then(function(){
                        output_msg = '\ncheckbox selection: ' + chk1;
                ...
                function(callback){
                    //test checkbox on ng-repeat  ##############
                    var chk1 = 'REPROMPT_REQUIRED' + 'CheckBox';
                    element3 = ptor.element(protractor.By.id(chk1));
                    //keyboard
                    element3.sendKeys(protractor.Key.SPACE).then(function(){
                        output_msg = '\ncheckbox selection: ' + chk1;
                ...
                function(callback){
                    //test checkbox on ng-repeat  ##############
                    var chk1 = 'ESCALATE_TO_AGENT' + 'CheckBox';
                    element3 = ptor.element(protractor.By.id(chk1));
                    //keyboard
                    element3.sendKeys(protractor.Key.SPACE).then(function(){
                        output_msg = '\ncheckbox selection: ' + chk1;
                ...
                function(callback){
                    ...
                    element1 = ptor.element(protractor.By.id('doneButton'));
                        //keyboard
                    element1.sendKeys(protractor.Key.ENTER).then(function(){
                        output_msg = '\nTested button entered by keyboard';
                        output_string += output_msg;
                        logger.info(output_msg);
                        //
                        callback(null, 22);
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[27][1]).to.match(/\"completionCause\":\"success\"/)
