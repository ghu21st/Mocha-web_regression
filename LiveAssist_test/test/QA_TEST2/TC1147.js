//TC1147: Verify that Live Assist sample app agent gui with flight intent outcome selected only: (Flight) -> (Booking)
//-------------------------------------------------------

describe('TC1147: Verify that Live Assist sample app agent gui with flight intent outcome selected only: (Flight) -> (Booking)', function() {
...
//-------------------------------------------------------
    it('TC1147: Verify that Live Assist sample app agent gui with flight intent outcome selected only: (Flight) -> (Booking)', function(done) {
