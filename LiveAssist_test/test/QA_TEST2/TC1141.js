//TC1141: Verify that Live Assist simple web API method /inputInteractionStep -> agent outcome selection -> agent GUI response & selection summary
//-------------------------------------------------------

describe('TC1141: Verify that Live Assist simple web API method /inputInteractionStep -> agent outcome selection -> agent GUI response & selection summary', function() {
...
//-------------------------------------------------------
    it('TC1141: Verify that Live Assist simple web API method /inputInteractionStep -> agent outcome selection -> agent GUI response & selection summary', function(done) {
...
//                    expect(result[12][0]).to.match(/Waive fee/);                     //intent check

                    //agent selection output check
                    expect(result[15][0]).to.match(/WAIVE_FEE_REQUEST/); //intent id
                    //Note: Just 'WAVI_FEE_REQUEST intent click, no variables, so no valid following variables check anymore
                    //expect(result[16][0][0]).to.match(/BILLING_MONTH/);
