//TC1177: Verify that Live Assist dynamic escalation classifier customized as Always escalation engine via IVR api call with agent outcome response
//US6815 dynamic escalation classifer
//-------------------------------------------------------
describe('TC1177: Verify that Live Assist dynamic escalation classifier customized as Always escalation engine via IVR api call with agent outcome response', function() {
...
//-------------------------------------------------------
    it('TC1177: Verify that Live Assist dynamic escalation classifier customized as Always escalation engine via IVR api call with agent outcome response', function(done) {
        ...
        async.series([
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[17][0].statusCode).to.eql(200);
                    expect(result[17][1]).to.match(/<state>agentPending<\/state>/);

                    expect(result[24][1]).to.match(/<inputInteractionStepResult>/)
