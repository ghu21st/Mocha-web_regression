//TC1137: Verify that Live Assist agent GUI with valid user name but invalid password sign in
//-------------------------------------------------------

describe('TC1137: Verify that Live Assist agent GUI with valid user name but invalid password sign in', function() {
...
//-------------------------------------------------------
    it('TC1137: Verify that Live Assist agent GUI with valid user name but invalid password sign in', function(done) {
  ...
  /*          function(callback){
    ...
    */
            ...
            function(callback){
                ...
                element1.sendKeys('xxxxx').then(function(){
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[8][0].toString()).to.match(/Error 401 Authentication Failed/)
                        .and.to.match(/Bad credentials/); //login page (all point to /app)
