//TC1182: Verify that Live Assist dynamic escalation classifier with confidence input < minimum_confidence_threshold and low_confidence_percentage=100
//US6815 dynamic escalation classifier
//-------------------------------------------------------
describe('TC1182: Verify that Live Assist dynamic escalation classifier with confidence input < minimum_confidence_threshold and low_confidence_percentage=100', function() {
...
//-------------------------------------------------------
    it('TC1182: Verify that Live Assist dynamic escalation classifier with confidence input < minimum_confidence_threshold and low_confidence_percentage=100', function(done) {
        ...
        var test_item1 = [
            {applicationContextId: 3, name: 'minimum_confidence_threshold', value: '0.5'},
            ...
            {applicationContextId: 3, name: 'low_confidence_percentage', value: '100'},
...
*/
        ...
        async.series([
                ...
                function(callback){
                    ...
                    //recognition emma result sent, conf = 0.4
            ...
            function(err, result){
                ...
                try{
                    ...
                    expect(result[6][1]).to.match(/\"applicationContextId\":3,\"name\":\"minimum_confidence_threshold\",\"value\":\"0.5\"/)
                        .and.to.match(/\"applicationContextId\":3,\"name\":\"maximum_confidence_threshold\",\"value\":\"0\"/)
                        .and.to.match(/\"applicationContextId\":3,\"name\":\"low_confidence_percentage\",\"value\":\"100\"/)
                        .and.to.match(/\"applicationContextId\":3,\"name\":\"immediate_percentage\",\"value\":\"0\"/)
                        .and.to.match(/\"applicationContextId\":3,\"name\":\"middle_confidence_percentage\",\"value\":\"0\"/)
