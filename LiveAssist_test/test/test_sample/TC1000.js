/**
 TC1000: Verify that Live Assist IVR VXML driven API method '/startSession'
 **/
//QA test case description, verification & assertion check
describe("TC1000: Verify that Live Assist IVR VXML driven HTTP API '/startSession'", function () {
    //QA test setup ----------------------------------------------
    ...
    var case_ID = 1000;
    var TEST_HOST = '10.3.41.54'; //change it if machine changed
    var TEST_PORT = 8080;
...
//                            console.log('\ndeleted module:' + key);
    ...
    it("TC1000: Verify that Live Assist IVR VXML driven API method '/startSession'", function (done) {
        ...
        async.series([
            ...
            function(callback){
                ...
                test_client.post(testBaseURL + '/startSession', testBodyParam, function(err, res, body){
                    ...
                    sessionID = body.match(/>(\d+)</)[1]; //pattern search found the real sessionID #
